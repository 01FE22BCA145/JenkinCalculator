...
class Calculator extends Extended_Calculator{
    ...
    public static void main(String[] args){
        ...
        float square=calc.square(operand_1);
        System.out.println("Result of Square is :"+ square);
        float cube=calc.cube(operand_1);
        System.out.println(" Result of Cube is "+ cube);
    }
}